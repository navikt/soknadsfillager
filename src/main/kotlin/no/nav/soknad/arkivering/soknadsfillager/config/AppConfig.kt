...
data class AppConfiguration(val restConfig: RestConfig = RestConfig(), val dbConfig: DBConfig = DBConfig()) {
	...
	data class RestConfig(
		...
		val password: String = readFileAsText("/var/run/secrets/nais.io/serviceuser/password", "APPLICORD".configProperty()),
		...
		val sharedPassword: String = readFileAsText("/var/run/secrets/nais.io/arkiverer/password", readFileAsText("/var/run/secrets/nais.io/kv/restPassword", "REST_PASSWORD".configProperty())),
